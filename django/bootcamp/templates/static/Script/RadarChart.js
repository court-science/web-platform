      ...
      g.selectAll(".nodes")
        ...
        .on('mouseover', function (d){
                      ...
                      tip.html(d.player_name+"<br>"+d.raw_value+" "+d.axis)
                          .style("left", (parseInt(this.getAttribute("cx")) + document.getElementById("chart-div").offsetLeft + this.getAttribute("r")*5) + "px")     
                          .style("top", (parseInt(this.getAttribute("cy")) + document.getElementById("chart-div").offsetTop - this.getAttribute("r")*5) + "px");
                  })
        .on('mouseout', function(){
                      tip.transition()		
                        .duration(500)		
